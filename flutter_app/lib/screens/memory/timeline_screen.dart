              ...
              children: [
                if (dateLabel != null)
                  Padding(
                    ...
                    child: Text(dateLabel!, style: const TextStyle(fontSize: 11, color: Color(0xFF8E8E93))),
                  ),
                Container(
                  width: 30,
                  height: 30,
                ...
                children: [
                  ...
                  if (item.desc.isNotEmpty && item.desc != item.title)
                    Padding(
                      ...
                      child: Text(item.desc, style: const TextStyle(fontSize: 13, color: Color(0xFF6E6E73))),
                    ),
                ],
              ),
            ),
