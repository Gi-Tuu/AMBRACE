...
class _HomeScreenState extends State<HomeScreen> with SingleTickerProviderStateMixin {
  ...
  Widget _drawerContent(SettingsProvider s, BuildContext c) {
    ...
    return ListView(padding: EdgeInsets.zero, children: [
      ...
      // 系统组：后台保活 / 数据备份 / 支持作者 / 更新公告 / 用户协议
      group('系统', [
        SwitchListTile(
          contentPadding: const EdgeInsets.symmetric(horizontal: 14),
          secondary: const Icon(Icons.auto_awesome_motion, size: 20, color: AppColors.accent),
          title: Text(l10n.backgroundKeepalive, style: const TextStyle(fontSize: 15, color: textColor)),
          subtitle: Text(l10n.backgroundKeepaliveHint, style: const TextStyle(fontSize: 11, color: subColor)),
          value: s.backgroundKeepalive,
          onChanged: (v) async {
            await s.setBackgroundKeepalive(v);
            if (v) {
