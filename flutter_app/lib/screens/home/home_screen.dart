...
import "../settings/permission_admin_screen.dart";
    ...
    return ListView(padding: EdgeInsets.zero, children: [
      ...
      group(l10n.groupExperience, [
        ...
        row(
          ...
          onTap: () {
            _closeDrawer();
            Navigator.push(c, AppPageRoute(builder: (_) => const PermissionAdminScreen()));
          },
        ),
        divider(),
        row(
          ...
          row(
            ...
            onTap: () async {
              ...
              if (ok == true && c.mounted) {
                Navigator.push(c, AppPageRoute(builder: (_) => const OnboardingScreen()));
              }
            },
          ),
        if (s.isLoggedIn) divider(),
