...
import '../settings/feature_flags_screen.dart';
import "../settings/permission_settings_screen.dart";
import "../settings/account_admin_screen.dart";
  ...
  Widget _drawerContent(SettingsProvider s, BuildContext c) {
    ...
    return ListView(padding: EdgeInsets.zero, children: [
      ...
      InkWell(
        onTap: () {
          _closeDrawer();
          Navigator.push(c, AppPageRoute(builder: (_) => const ProfileScreen()));
        },
        child: Container(
      ...
      group(l10n.groupConnection, [
        ...
        row(
          ...
          onTap: () => _checkConnection(c, s),
          trailing: TextButton(
            onPressed: () => _checkConnection(c, s),
      ...
      group(l10n.groupExperience, [
        ExpansionTile(
          leading: const Icon(Icons.tune, size: 20, color: AppColors.accent),
          title: Text(l10n.experienceSettingsTitle, style: const TextStyle(fontSize: 15, color: textColor)),
          subtitle: Text(l10n.experienceSettingsSubtitle, style: const TextStyle(fontSize: 11, color: subColor)),
          ...
          children: [
            ListTile(
              leading: const Icon(Icons.visibility_outlined, size: 20, color: AppColors.accent),
              ...
              onTap: () {
                _closeDrawer();
                Navigator.push(c, AppPageRoute(builder: (_) => const PhonePerceptionScreen()));
              },
            ),
            ListTile(
              leading: const Icon(Icons.do_not_disturb, size: 20, color: AppColors.accent),
              ...
              onTap: () {
                _closeDrawer();
                Navigator.push(c, AppPageRoute(builder: (_) => const DndSettingsScreen()));
              },
            ),
            ListTile(
              leading: const Icon(Icons.extension_outlined, size: 20, color: AppColors.accent),
              ...
              onTap: () {
                _closeDrawer();
                Navigator.push(c, AppPageRoute(builder: (_) => const ExtensionsScreen()));
              },
            ),
            ListTile(
              leading: const Icon(Icons.palette_outlined, size: 20, color: AppColors.accent),
        ...
        row(
          ...
          title: l10n.weaveLibraryTitle,
          subtitle: l10n.weaveLibrarySubtitle,
          onTap: () {
            _closeDrawer();
            Navigator.push(c, AppPageRoute(builder: (_) => const WeaveLibraryScreen()));
          },
        ),
        divider(),
        row(
          ...
          onTap: () {
            _closeDrawer();
            Navigator.push(c, AppPageRoute(builder: (_) => const PermissionSettingsScreen()));
          },
        ),
        if (s.isAdmin) ...[
          row(
            ...
            subtitle: l10n.accountAdminHint,
            onTap: () {
              _closeDrawer();
              Navigator.push(c, AppPageRoute(builder: (_) => const AccountAdminScreen()));
            },
          ),
        ],
        divider(),
        row(
          ...
          onTap: () {
            _closeDrawer();
            Navigator.push(c, AppPageRoute(builder: (_) => const ApiConfigScreen()));
          },
        ),
        divider(),
        row(
          icon: Icons.toggle_on_outlined,
          title: l10n.featureFlagsTitle,
          subtitle: l10n.featureFlagsHint,
          onTap: () {
            _closeDrawer();
            Navigator.push(c, AppPageRoute(builder: (_) => const FeatureFlagsScreen()));
          },
        ),
      ]),
      // 系统组：更新公告 / 数据备份 / 支持作者
      group(l10n.groupSystem, [
        row(
          ...
          onTap: () {
            _closeDrawer();
            Navigator.push(c, AppPageRoute(builder: (_) => const UpdateAnnouncementScreen()));
          },
        ),
        divider(),
        row(
          ...
          onTap: () {
            _closeDrawer();
            Navigator.push(c, AppPageRoute(builder: (_) => const BackupScreen()));
          },
        ),
        divider(),
        row(
          ...
          onTap: () {
            _closeDrawer();
            Navigator.push(c, AppPageRoute(builder: (_) => const SupportScreen()));
          },
        ),
      ]),
      // 关于组：关于/版本 + 退出登录
      group(l10n.groupAbout, [
        ...
        row(
          ...
          onTap: () {
            _closeDrawer();
            Navigator.push(c, AppPageRoute(builder: (_) => const UserAgreementScreen()));
          },
        ),
