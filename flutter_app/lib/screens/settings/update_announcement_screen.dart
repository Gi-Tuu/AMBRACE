...
class _UpdateAnnouncementScreenState extends State<UpdateAnnouncementScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      if (mounted) {
        setState(() { _error = '加载失败，请检查服务器连接'; _loading = false; });
      }
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('更新公告')),
      body: _loading
          ...
          : _error != null
              ...
              : _days.isEmpty
                  ? const Center(child: Text('暂无更新记录', style: TextStyle(color: IosCardColors.subtitle)))
                  : ListView.builder(
                              ...
                              Material(
                                ...
                                child: ExpansionTile(
                                  ...
                                  children: items.isEmpty
                                      ? [const ListTile(title: Text('（无明细）', style: TextStyle(color: IosCardColors.subtitle, fontSize: 13)))]
                                      : [
