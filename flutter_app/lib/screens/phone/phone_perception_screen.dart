...
class _PhonePerceptionScreenState extends State<PhonePerceptionScreen> with WidgetsBindingObserver {
      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            ...
            color: ok ? const Color(0xFF34C759) : const Color(0xFFC6C6C8),
          ),
        ),
        const SizedBox(width: 5),
        Text(label, style: const TextStyle(fontSize: 12, color: Color(0xFF6E6E73))),
      ],
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    const iconColor = Color(0xFF007AFF);
    ...
    Widget nav({
      ...
      return ListTile(
        ...
        subtitle: Text(subtitle, style: const TextStyle(fontSize: 11, color: subColor)),
        enabled: enabled,
        trailing: trailing ?? const Icon(Icons.chevron_right, size: 18, color: Color(0xFFC6C6C8)),
        onTap: onTap,
        contentPadding: const EdgeInsets.symmetric(horizontal: 14),
      );
    }
        ...
        children: [
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: TextStyle(
                          ...
                          color: _shizukuReady ? const Color(0xFF34C759) : subColor,
                        ),
                      ),
                    ],
                  ),
            ...
            if (_expandLocation) ...[
              ...
              Padding(
                ...
                child: nav(
                  ...
                  trailing: const Icon(Icons.edit_outlined, size: 20, color: Color(0xFFC6C6C8)),
          ...
          group(l10n.ppGroupPrivacy, [
            Padding(
              ...
              child: Text(
                l10n.ppPrivacyNote,
                style: const TextStyle(fontSize: 12, color: Color(0xFF6E6E73), height: 1.6),
              ),
            ),
          ]),
          // 操作与记录
          group(l10n.ppGroupActions, [
            ...
            nav(
              ...
              trailing: _historyLoading
                  ...
                  : const Icon(Icons.chevron_right, size: 18, color: Color(0xFFC6C6C8)),
              onTap: () {
            ...
            ListTile(
              ...
              title: Text(l10n.ppClearAll, style: const TextStyle(fontSize: 15, color: Color(0xFFFF3B30))),
              contentPadding: const EdgeInsets.symmetric(horizontal: 14),
              onTap: _clearAll,
            ),
          ]),
