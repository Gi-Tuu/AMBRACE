...
class _AppPickerScreenState extends State<AppPickerScreen> {
    ...
    try {
      ...
      setState(() {
        ...
        if (r['ok'] != true) {
          ...
          _apps = apps;
          if (_apps.isEmpty) _error = '未读取到已安装应用';
        }
      });
    } catch (e) {
      if (!mounted) return;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('选择应用')),
      body: Column(
        children: [
          Padding(
          ...
          Expanded(
            child: _loading
                ...
                : _error != null
                    ...
                    : filtered.isEmpty
                        ? const Center(child: Text('未找到应用', style: TextStyle(color: Colors.grey)))
                        : ListView.builder(
