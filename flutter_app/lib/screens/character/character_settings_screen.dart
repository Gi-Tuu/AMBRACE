...
class _CharacterSettingsScreenState extends State<CharacterSettingsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text(l10n.charSettings)),
      body: _loading
          ? const Center(child: CircularProgressIndicator())
          : ListView(
              padding: const EdgeInsets.only(top: 8, bottom: 24),
              children: [
                IosCardGroup(title: l10n.dailyGroup, children: [
                  _groupSwitchTile(
                  ...
                  const IosCardDivider(indent: 52),
                  _expansionSwitch(
                ...
                IosCardGroup(title: l10n.creationGroup, children: [
                  _expansionSwitch(
                ...
                IosCardGroup(title: l10n.worldGroup, children: [
                  ListTile(
                    leading: const Icon(Icons.menu_book_outlined, size: 22, color: Color(0xFF007AFF)),
                    title: Text(l10n.lorebookTitle, style: const TextStyle(fontSize: 15)),
                    subtitle: Text(l10n.lorebookHint,
                        style: const TextStyle(fontSize: 11, color: IosCardColors.subtitle)),
                    trailing: const Icon(Icons.chevron_right, size: 18, color: Color(0xFFC6C6C8)),
                  ...
                  const IosCardDivider(indent: 52),
                  ListTile(
                    leading: const Icon(Icons.public_outlined, size: 22, color: Color(0xFF007AFF)),
                ...
                IosCardGroup(title: l10n.socialGroup, children: [
                  _groupSwitchTile(
                ...
                IosCardGroup(title: l10n.privacyGroup, children: [
                  _expansionSwitch(
                ...
                IosCardGroup(title: l10n.statusGroup, children: [
                  _expansionSwitch(
  ...
  Widget _groupSwitchTile({
    ...
    return InkWell(
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            Icon(icon, size: 22, color: value ? Theme.of(context).colorScheme.primary : IosCardColors.subtitle),
  ...
  Widget _expansionSwitch({
    ...
    return Theme(
      ...
      child: ExpansionTile(
        leading: Icon(icon, size: 22, color: value ? scheme.primary : IosCardColors.subtitle),
        title: Text(title,
            style: TextStyle(
        ...
        trailing: Row(
          ...
          children: [
            Icon(isOpen ? Icons.expand_less : Icons.expand_more,
                size: 20, color: const Color(0xFFC6C6C8)),
            Switch(value: value, onChanged: onChanged),
          ],
        ),
        children: children,
