...
class _CharacterEditScreenState extends State<CharacterEditScreen> {
  ...
  void initState() {
    ...
    _greetingCtrl = TextEditingController(text: c?.greetingMessage ?? '');
  ...
  Future<void> _save() async {
    ...
    final data = {
      ...
      'greeting_message': _greetingCtrl.text,
          ...
          children: [
            ...
            IosCardGroup(
              ...
              children: [
                ...
                const IosCardDivider(),
                _buildField(_greetingCtrl,
                    label: l10n.greeting, hint: l10n.greetingHint, maxLines: 2),
              ],
            ),
            IosCardGroup(
