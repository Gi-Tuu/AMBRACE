...
class _UserVisualStateScreenState extends State<UserVisualStateScreen> {
    ...
    try {
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text(l10n.myStateSaved)),
        );
      }
    } catch (_) {
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text(l10n.permSaveFailed)),
        );
      }
    }
  }
  ...
  Widget build(BuildContext context) {
    final l10n = AppLocalizations.of(context)!;
    return Scaffold(
      appBar: AppBar(title: Text(l10n.myStateTitle)),
      body: _loading
          ? const Center(child: CircularProgressIndicator())
          : _error != null
              ? Center(child: Column(mainAxisSize: MainAxisSize.min, children: [
                  Text(l10n.myStateLoadFail(_error!), textAlign: TextAlign.center),
                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      if (_state != null && _state!.updatedAt.isNotEmpty)
                        Center(child: Text(l10n.myStateUpdatedAt(formatBeijingTime(_state!.updatedAt)), style: const TextStyle(fontSize: 11, color: IosCardColors.subtitle))),
                      const SizedBox(height: 8),
                      Padding(
                        padding: const EdgeInsets.only(left: 4, bottom: 4),
                        child: Text(l10n.myStateSliderHint,
                      ...
                      Row(children: [
                        ...
                        Expanded(
                          child: FilledButton.icon(
                            ...
                            label: Text(_saving ? l10n.myStateSaving : l10n.myStateSave),
                          ),
                        ),
                      ]),
                    ],
