...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  Future<void> _finish() async {
    ...
    if (!mounted) return;
    _enterApp(autoChat: true, greeting: l10n.onboardingFirstMessage);
  }
  ...
  /// 进入应用：替换到主页；按需推入聊天页并自动发送首条消息，或引导到设置页。
  void _enterApp({required bool autoChat, required String greeting}) {
