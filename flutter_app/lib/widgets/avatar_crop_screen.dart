  ...
  void _confirm() {
    ...
    if (!_ready) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text(l10n.cropLoadingImage)),
      );
      return;
    }
    ...
    _timeout = Timer(const Duration(seconds: 15), () {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text(l10n.cropTimeoutRetry)),
      );
    });
    _controller.crop();
  }
      ...
      appBar: AppBar(
        ...
        actions: [
          TextButton(
            ...
            child: Text(
              _cropping ? l10n.cropProcessing : l10n.furnitureConfirm,
              style: const TextStyle(
                  color: Colors.white,
                  fontSize: 16,
            ...
            child: Crop(
              ...
              onCropped: (result) {
                ...
                if (result is CropSuccess) {
                  ...
                  setState(() => _cropping = false);
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(content: Text(l10n.cropFailedRetry)),
                  );
                }
              },
              aspectRatio: 1,
