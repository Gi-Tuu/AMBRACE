...
class AppLocalizationsZh extends AppLocalizations {
  ...
  @override
  String get agentMindStatHit => '命中';

  @override
  String get agentMindStatMiss => '未命中';

  @override
  String get agentMindStatAvgLatency => '平均耗时';
  ...
  @override
  String get flagDetail => '详情';

  @override
  String get flagCollapse => '收起';
  ...
  @override
  String get appearanceSubtitle => '皮肤、主题色与深浅模式，一键切换外观';
  ...
  @override
  String get serverUrlHint => 'http://服务器IP:8000';
  ...
  @override
  String get diaryNoEntry => '这天没有写日记';
  ...
  @override
  String get editDiscardConfirm => '内容尚未发布，确定放弃编辑吗？';
  ...
  @override
  String get momentComposeHint => '记录此刻的想法…';
  ...
  @override
  String get noBasicInfo => '暂无基本信息';

  @override
  String get noTags => '暂无标签';

  @override
  String get noAppearanceDesc => '暂无形象描述';
  ...
  @override
  String get glassAuroraStart => '起色';

  @override
  String get glassBackgroundGradient => '渐变';

  @override
  String get glassBackgroundImage => '相册图片';

  @override
  String get glassBackgroundReset => '重置';

  @override
  String get glassBackgroundTitle => '背景';

  @override
  String get glassBlurLabel => '模糊';

  @override
  String get glassDimHint => '文字看不清时调高压暗';

  @override
  String get glassDimLabel => '压暗';

  @override
  String get glassImagePickFailed => '选择背景图片失败';

  @override
  String get glassImageSaved => '背景图片已保存';

  @override
  String get glassPickImage => '选择图片';
  ...
  @override
  String get noAiFriend => '还没有AI好友，点击右下角按钮创建';
  ...
  @override
  String get channelRefreshList => '刷新列表';

  @override
  String get degradedReplyHint => '（TA 想得太久，一时没说出来）';

  @override
  String get menuSayAgain => '让 TA 再说一次';

  @override
  String get degradedNoSource => '找不到上一条消息，没法重说啦';

  @override
  String get channelQrScanLogin => '扫码登录新号';

  @override
  String get channelQrLoginTitle => '扫码登录';

  @override
  String get channelQrFetching => '正在获取二维码…';

  @override
  String get channelQrScanHintWechat => '请用手机微信「扫一扫」识别二维码';

  @override
  String get channelQrScanHintDouyin => '请用抖音 App 扫描二维码登录';

  @override
  String get channelQrWaiting => '等待扫码…';

  @override
  String get channelQrScanned => '已扫码，请在手机上确认';

  @override
  String get channelQrNeedVerifyTitle => '输入配对码';

  @override
  String get channelQrNeedVerifyHint => '请输入手机微信上显示的数字，以继续连接';

  @override
  String get channelQrVerifyWrong => '数字不匹配，请重新输入';

  @override
  String get channelQrVerifyBlocked => '配对码多次错误，请稍后再试';

  @override
  String get channelQrRefreshing => '二维码已过期，正在刷新…';

  @override
  String get channelQrExpiredFinal => '二维码多次过期，请稍后再试';

  @override
  String get channelQrRefresh => '刷新二维码';

  @override
  String get channelQrPickChar => '选择绑定到新机器人的角色';

  @override
  String get channelQrBinding => '正在绑定…';
  ...
  @override
  String get channelQrGatewayPending => '新号已写入网关，重启网关后开始收发消息';

  @override
  String get channelQrBindedRedirect => '该机器人已登录过网关，请用「查看可添加的机器人」绑定';
  ...
  @override
  String get douyinQrWaiting => '等待扫码登录…';

  @override
  String get douyinQrBindOnPc => '在电脑上扫码';

  @override
  String get douyinQrBindOnPcHint => '服务器将弹出浏览器窗口，请在电脑前用抖音扫码';

  @override
  String get douyinQrSuccess => '登录成功，账号已绑定';

  @override
  String get douyinQrEnded => '扫码会话已结束';
  ...
  @override
  String get gameSurrender => '投降';

  @override
  String get gameSurrenderConfirm => '确认投降？单人/双人将直接判负，多人对局中你将转为观战。';
  ...
  @override
  String get performanceMotionTitle => '性能与动效';

  @override
  String get reduceMotionLabel => '减少动效';

  @override
  String get reduceMotionHint => '关闭浮动、脉冲等持续动画';

  @override
  String get reduceBlurLabel => '降低模糊效果';
  ...
  @override
  String get flagGroupAgentRuntime => '智能体运行与认知';

  @override
  String get flagGroupProactive => '主动消息';

  @override
  String get flagGroupGroupGames => '群聊小游戏';

  @override
  String get flagGroupLifeLoop => 'AI 自主生活';

  @override
  String get flagGroupLifeSense => '生命感增强';

  @override
  String get flagGroupProactiveNatural => '主动消息自然化（B1）';

  @override
  String get flagGroupMemory => '记忆检索与注入（实验灰度）';

  @override
  String get flagGroupCurated => '编纂知识与前瞻意图';

  @override
  String get flagGroupCrossChar => '跨角色用户事实（B1）';

  @override
  String get flagGroupWorking => '工作记忆（M3）';

  @override
  String get flagGroupProvider => '插件与提供商';

  @override
  String get flagGroupOther => '其他高级开关';

  @override
  String get flagAgentLoopChatTitle => '聊天主循环';

  @override
  String get flagAgentLoopChatHint => 'AI 回复走统一的智能体主循环：理解 → 记忆 → 规划 → 回答。';
  ...
  @override
  String get flagAgentContextTrimHint => '低频角色少注入、高频角色全量注入，以节省 token。';
  ...
  @override
  String get flagAgentTraceGroupTitle => '群聊过程记录';

  @override
  String get flagAgentTraceGroupHint => '记录群聊中每个角色回应的决策过程（只写不读，用于排查）。';
  ...
  @override
  String get flagProactiveUserRhythmTitle => '用户作息学习';

  @override
  String get flagProactiveUserRhythmHint => '学习你的活跃时段，非活跃时间推迟低优先主动消息。';
  ...
  @override
  String get flagLifeLoopEnabledHint => '约每 30 分钟让 AI 自主决策一次行为，形成自己的生活节奏。';
  ...
  @override
  String get flagLifeLoopLlmHint => '允许用大模型写生活文案（每角色每日上限 2 次）。';
  ...
  @override
  String get flagReplyDelayEnabledHint => '按情境给回复加自然的短暂延迟（仅你主动发消息时生效）。';

  @override
  String get flagReplyDelayEnabledDetail => '模拟真人思考/打字节奏；关闭则回复立即开始。';

  @override
  String get flagSpringEmotionEnabledTitle => '弹簧阻尼情绪';

  @override
  String get flagSpringEmotionEnabledHint => '四维情绪 + 人格基线，情绪起伏后自然回落到基线。';

  @override
  String get flagSpringEmotionEnabledDetail => '让心情像真人一样波动而非跳变；关闭则用旧的简单情绪模型。';

  @override
  String get flagLifeShareEnabledTitle => '活动自然分享';

  @override
  String get flagLifeShareEnabledHint => '活动完成后在合适时机自然分享给你（带频率门控，防刷屏）。';

  @override
  String get flagLifeShareEnabledDetail => '关闭后 AI 不会主动分享刚完成的活动。';
  ...
  @override
  String get flagProactiveOutreachV2Hint => '按闲置时长与素材挑选「接触意图」，告别硬续旧剧情与逐句复读。';
  ...
  @override
  String get flagMemoryTemporalRecallTitle => '时间维度记忆检索';

  @override
  String get flagMemoryTemporalRecallHint => '用户提到具体时间（昨天/上周/某月）时，补一条确定性时间窗检索。';
  ...
  @override
  String get flagMemoryRecallSecondHopTitle => '按需二跳调取记忆（RECALL）';
  ...
  @override
  String get flagMemoryPeakCutoffHint => '弱相关记忆整体低于相关度地板时自然收敛，避免硬塞条数。';
  ...
  @override
  String get flagMemoryChainBuilderTitle => '记忆链条建链';

  @override
  String get flagMemoryChainBuilderHint => '事件/洞察类新记忆自动挂到相近的既有记忆链上（零额外 LLM）。';
  ...
  @override
  String get flagMemoryChainExpandTitle => '沿链上下文补全';

  @override
  String get flagMemoryChainExpandHint => '检索命中时沿链补最多 2 个相邻节点，前因后果更完整。';
  ...
  @override
  String get flagMarkerRecoveryHint => '记忆标记被上下文截断时，源消息立即走备选通道补提取。';

  @override
  String get flagMarkerRecoveryDetail => 'M2-S5：写侧查重防重复；关=仅依赖批量补提。';

  @override
  String get flagReviewDailyPlusTitle => '主动复习扩容';

  @override
  String get flagReviewDailyPlusHint => '主动复习每日额度由 3 条提高到 4 条（M1-S7）。';

  @override
  String get flagReviewDailyPlusDetail => '关=回退每日 3 条，90 分钟最小间隔不变。';

  @override
  String get flagCuratedKnowledgeTitle => '编纂知识层（长期稳定事实）';

  @override
  String get flagCuratedKnowledgeHint => '人格铁律/用户硬档案/关系基线等长期知识确定性注入，不随记忆衰减。';
  ...
  @override
  String get flagProspectiveIntentEnabledTitle => '前瞻意图-写入';
  ...
  @override
  String get flagProspectiveIntentTriggerTitle => '前瞻意图-触发';
  ...
  @override
  String get flagGlobalUserFactsTitle => '全局用户事实（USER NOW）';

  @override
  String get flagGlobalUserFactsHint => '用户级单值事实（位置等）跨角色共享，低活跃角色不再停留在旧信息。';
  ...
  @override
  String get flagWorkingStateEnabledHint => '每轮对话后评估当前认知状态并滚动覆盖写入工作记忆。';
  ...
  @override
  String get flagProviderRegistryTitle => '提供商注册口';
