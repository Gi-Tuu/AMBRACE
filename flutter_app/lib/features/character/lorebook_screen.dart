...
class _LorebookEditDialogState extends State<_LorebookEditDialog> {
  ...
  late final TextEditingController _sticky;
  ...
  void initState() {
    ...
    _isRegex = item?['is_regex'] == true;
    _probability = (item?['probability'] as num?)?.toInt() ?? 100;
    _group = TextEditingController(text: item?['inclusion_group'] as String? ?? "");
    _sticky = TextEditingController(text: item?['sticky_rounds']?.toString() ?? "0");
    _coolDown = TextEditingController(text: item?['cooldown_rounds']?.toString() ?? "0");
  }
  ...
  Future<void> _save() async {
    ...
    try {
      final api = ApiClient();
      final item = widget.item;
      final sticky = int.tryParse(_sticky.text.trim()) ?? 0;
      ...
      if (item == null) {
        await api.createLorebook(widget.characterId,
            ...
            active: _active,
            isRegex: _isRegex, probability: _probability,
            inclusionGroup: _group.text.trim(),
            stickyRounds: sticky, cooldownRounds: coolDown);
      } else {
        ...
        child: Column(
          ...
          children: [
            ...
            SwitchListTile(
              ...
              title: Text(l10n.lorebookRegex),
              subtitle: Text(l10n.lorebookRegexHint),
              value: _isRegex,
            ...
            Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    Text(l10n.lorebookProbability, style: const TextStyle(fontSize: 13)),
                    Text('$_probability%', style: const TextStyle(fontSize: 13)),
                  ],
                ),
                Slider(
            ...
            TextField(
              controller: _group,
              decoration: InputDecoration(
                labelText: l10n.lorebookGroup,
                helperText: l10n.lorebookGroupHint,
              ),
            ),
            TextField(
              controller: _sticky,
              ...
              decoration: InputDecoration(
                labelText: l10n.lorebookSticky,
                helperText: l10n.lorebookStickyHint,
              ),
            ),
            TextField(
              ...
              keyboardType: TextInputType.number,
              decoration: InputDecoration(
                labelText: l10n.lorebookCooldown,
                helperText: l10n.lorebookCooldownHint,
              ),
            ),
            SwitchListTile(
              contentPadding: EdgeInsets.zero,
