...
def test_send_and_receive_stream_tts_llm_error_sends_reset_blocks(monkeypatch):
    ...
    monkeypatch.setattr(cs, "async_session_factory", lambda: _FakeCtx())
    ...
    monkeypatch.setattr(cs, "_persist_user_message", _persist_user)
    monkeypatch.setattr(cs, "_run_agent_core", _run_core)
    monkeypatch.setattr(cs, "_delete_chunks", _delete_chunks)
...
def test_send_and_receive_stream_tts_partial_falls_back_to_batch(monkeypatch):
    ...
    monkeypatch.setattr(cs, "_run_agent_core", _run_core)
    monkeypatch.setattr(cs, "_delete_chunks", _delete_chunks)
    monkeypatch.setattr(cs, "_persist_ai_chunks", _persist_chunks)
    monkeypatch.setattr(cs, "_synthesize_chunks_tts", _synth_tts)
    monkeypatch.setattr(cs, "_backfill_stream_tts_meta", _backfill)
    monkeypatch.setattr(cs, "_push_user_notify", _noop)
    monkeypatch.setattr(cs, "_run_post_processing", _noop)
