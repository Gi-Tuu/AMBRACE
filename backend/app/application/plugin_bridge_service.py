...
async def ai_dispatch(plugin_name: str, params: dict, user_id: int, lang: str = "zh") -> dict:
    ...
    if ai_id is not None:
        ...
        try:
            from app.application.character_chat_api import chat_with_character
...
async def dispatch(plugin_name: str, api: str, params: dict, user_id: int, lang: str = "zh") -> dict:
    ...
    if api == "getAiList":
        try:
            from app.application.character_chat_api import list_characters
    ...
    if api == "getAiInfo":
        try:
            ...
            return {"ok": False, "error": tr_lang(lang, "ai_character_not_found")}
        try:
            from app.application.character_chat_api import get_character_detail
