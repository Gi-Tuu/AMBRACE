    ...
    try:
        while _running:
            ...
            if state_decay_counter >= 3600:
                ...
                asyncio.ensure_future(drift_all_character_states())
            ...
            if file_cleanup_counter >= 21600:
                ...
                asyncio.ensure_future(cleanup_expired_files(days=5))
                # 语音/TTS 音频保留 14 天：超期删除文件并清空消息元数据（仅保留转写/回复文本）
                asyncio.ensure_future(cleanup_expired_voice(days=14))
