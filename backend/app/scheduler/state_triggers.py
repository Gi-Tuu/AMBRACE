    ...
    try:
        async with async_session_factory() as db:
            ...
            if not enabled:
                lg.recovered = True
                await db.commit()
                from app.scheduler.storyline_engine import close_storyline_episode
...
async def _execute_rule_behavior(
    ...
    recent_ctx = ""
    try:
        from app.services.chat_service import get_latest_session_id as _get_sid
        from app.scheduler.triggers import get_last_messages as _get_last
    ...
    try:
        async with async_session_factory() as db:
            ...
            if dirty:
                ...
                from app.scheduler.storyline_engine import close_storyline_episode, TRIGGER_TO_STORYLINE
