...
if errorlevel 1 (
    echo [ERROR] Python not found. Install Python 3.10+ with "Add to PATH" checked.
    pause
    exit /b 1
)
...
echo [4/4] Self-check...
if not exist backend\models\bge-small-zh-v1.5 (
    echo   [WARN] Missing backend\models\bge-small-zh-v1.5 - memory system will not start.
