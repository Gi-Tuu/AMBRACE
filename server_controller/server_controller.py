...
class ControllerApp:
    ...
    def _build_dashboard_page(self) -> tk.Frame:
        ...
        trend_inner.pack(fill="both", expand=True, padx=SP_LG, pady=SP_LG)
        tk.Label(trend_inner, text="近 7 天 Token 用量", fg=COL_TEXT_SEC, bg=COL_CARD,
                 font=(FONT, 12)).pack(anchor="w")
        self.trend_canvas = tk.Canvas(trend_inner, height=190, bg=COL_CARD, highlightthickness=0, bd=0)
